...
public class QuestUtils {
    ...
    public static List<QuestData> getQuests(Context context) {
        ...
        quests.addAll(Arrays.asList(
                ...
                new QuantityQuestData(context, context.getString(R.string.quest_title_pumpkins), context.getString(R.string.quest_desc_pumpkins), context.getString(R.string.quest_complete_pumpkins), ItemUtils.KEY_ITEM_PUMPKIN, 4)
        ));
